...
const Navbar = () => {
    return (
        <div className='bg-white'>
            <div className="navbar max-w-[1200px] mx-auto text-black">
                ...
                <div className="navbar-end">
                    <a className="btn bg-gradient-to-br from-[#632EE3] to-[#9F62F2] border-none text-[10px] md:text-[13px] lg:text-[16px]" href='https://github.com/naymulislamnay'>
